...
# pe = pefile.PE('cdstyle.docx')

print(pe.DIRECTORY_ENTRY_RESOURCE)

print(pe.DIRECTORY_ENTRY_RESOURCE.entries)

print(pe.DIRECTORY_ENTRY_RESOURCE.entries[3])
...
print("pefile.RESOURCE_TYPE['RT_STRING']:", pefile.RESOURCE_TYPE['RT_STRING'])
